...
class DemoDataManager {
    ...
    initializeData() {
        ...
        this.ingredients = [
            // Proteins
            { id: 1, name: 'Chicken Breast', category: 'meat', default_unit: 'lbs', cost_per_unit: 6.99, storage_notes: 'Refrigerate, use within 3 days', nutrition: { protein: 31, carbs: 0, fat: 3.6, calories: 165 } },
            { id: 2, name: 'Ground Beef', category: 'meat', default_unit: 'lbs', cost_per_unit: 5.49, storage_notes: 'Refrigerate, use within 2 days', nutrition: { protein: 26, carbs: 0, fat: 15, calories: 250 } },
            { id: 3, name: 'Salmon Fillet', category: 'meat', default_unit: 'lbs', cost_per_unit: 12.99, storage_notes: 'Refrigerate, use within 2 days', nutrition: { protein: 25, carbs: 0, fat: 11, calories: 206 } },
            { id: 4, name: 'Eggs', category: 'dairy', default_unit: 'dozen', cost_per_unit: 3.49, storage_notes: 'Refrigerate', nutrition: { protein: 6, carbs: 0.6, fat: 5, calories: 70 } },
            { id: 5, name: 'Tofu', category: 'meat', default_unit: 'lbs', cost_per_unit: 3.99, storage_notes: 'Refrigerate after opening', nutrition: { protein: 8, carbs: 2, fat: 4, calories: 70 } },

            // Vegetables
            { id: 6, name: 'Broccoli', category: 'produce', default_unit: 'lbs', cost_per_unit: 2.99, storage_notes: 'Refrigerate', nutrition: { protein: 3, carbs: 6, fat: 0.4, calories: 25 } },
            { id: 7, name: 'Carrots', category: 'produce', default_unit: 'lbs', cost_per_unit: 1.49, storage_notes: 'Refrigerate', nutrition: { protein: 0.9, carbs: 10, fat: 0.2, calories: 41 } },
            { id: 8, name: 'Bell Peppers', category: 'produce', default_unit: 'pieces', cost_per_unit: 1.99, storage_notes: 'Refrigerate', nutrition: { protein: 1, carbs: 7, fat: 0.3, calories: 31 } },
            { id: 9, name: 'Onions', category: 'produce', default_unit: 'lbs', cost_per_unit: 1.29, storage_notes: 'Store in cool, dry place', nutrition: { protein: 1.1, carbs: 9.3, fat: 0.1, calories: 40 } },
            { id: 10, name: 'Garlic', category: 'produce', default_unit: 'pieces', cost_per_unit: 0.99, storage_notes: 'Store in cool, dry place', nutrition: { protein: 0.6, carbs: 3, fat: 0, calories: 13 } },
            { id: 11, name: 'Spinach', category: 'produce', default_unit: 'lbs', cost_per_unit: 3.99, storage_notes: 'Refrigerate', nutrition: { protein: 2.9, carbs: 3.6, fat: 0.4, calories: 23 } },
            { id: 12, name: 'Tomatoes', category: 'produce', default_unit: 'lbs', cost_per_unit: 2.49, storage_notes: 'Store at room temperature', nutrition: { protein: 0.9, carbs: 3.9, fat: 0.2, calories: 18 } },

            // Grains & Starches
            { id: 13, name: 'Rice', category: 'grains', default_unit: 'lbs', cost_per_unit: 2.99, storage_notes: 'Store in airtight container', nutrition: { protein: 2.7, carbs: 28, fat: 0.3, calories: 130 } },
            { id: 14, name: 'Pasta', category: 'grains', default_unit: 'lbs', cost_per_unit: 1.99, storage_notes: 'Store in cool, dry place', nutrition: { protein: 5, carbs: 31, fat: 0.9, calories: 131 } },
            { id: 15, name: 'Bread', category: 'grains', default_unit: 'loaves', cost_per_unit: 2.49, storage_notes: 'Store at room temperature', nutrition: { protein: 3.6, carbs: 12, fat: 1.2, calories: 69 } },
            { id: 16, name: 'Potatoes', category: 'produce', default_unit: 'lbs', cost_per_unit: 1.99, storage_notes: 'Store in cool, dark place', nutrition: { protein: 2, carbs: 17, fat: 0.1, calories: 77 } },
            { id: 17, name: 'Quinoa', category: 'grains', default_unit: 'lbs', cost_per_unit: 5.99, storage_notes: 'Store in airtight container', nutrition: { protein: 4.4, carbs: 22, fat: 1.9, calories: 120 } },
            ...
            // Pantry Items
            { id: 22, name: 'Olive Oil', category: 'pantry', default_unit: 'bottles', cost_per_unit: 7.99, storage_notes: 'Store in cool, dark place', nutrition: { protein: 0, carbs: 0, fat: 14, calories: 119 } },
            { id: 23, name: 'Salt', category: 'pantry', default_unit: 'containers', cost_per_unit: 1.99, storage_notes: 'Store in dry place', nutrition: { protein: 0, carbs: 0, fat: 0, calories: 0 } },
            { id: 24, name: 'Black Pepper', category: 'pantry', default_unit: 'containers', cost_per_unit: 3.99, storage_notes: 'Store in cool, dry place', nutrition: { protein: 0.1, carbs: 0.6, fat: 0, calories: 3 } },
            { id: 25, name: 'Soy Sauce', category: 'pantry', default_unit: 'bottles', cost_per_unit: 2.99, storage_notes: 'Store at room temperature', nutrition: { protein: 1.3, carbs: 0.8, fat: 0, calories: 8 } },
            { id: 26, name: 'Lemon', category: 'produce', default_unit: 'pieces', cost_per_unit: 0.79, storage_notes: 'Refrigerate', nutrition: { protein: 0.6, carbs: 5.4, fat: 0.2, calories: 17 } },
