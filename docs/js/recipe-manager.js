                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
                        <div class="flex flex-wrap items-center justify-center gap-6 text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-semibold text-blue-700 dark:text-blue-300">${this.getFilteredRecipes().length}</span>
                                <span class="text-gray-600 dark:text-gray-400">${this.getFilteredRecipes().length === 1 ? 'recipe' : 'recipes'}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-semibold text-green-700 dark:text-green-300">${this.getFilteredLabels().length}</span>
                                <span class="text-gray-600 dark:text-gray-400">${this.getFilteredLabels().length === 1 ? 'label' : 'labels'}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-semibold text-yellow-700 dark:text-yellow-300">${this.getFilteredRecipes().filter(r => r.favorite === true).length}</span>
                                <span class="text-gray-600 dark:text-gray-400">${this.getFilteredRecipes().filter(r => r.favorite === true).length === 1 ? 'fav' : 'favs'}</span>
                            </div>
                        </div>
                    </div>
